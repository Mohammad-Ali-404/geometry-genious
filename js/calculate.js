document.getElementById('btn-triangle').addEventListener('click', function () {
    const newTriangleCalculateFraction = getInnerTextById('triangle-fraction');
    console.log(newTriangleCalculateFraction)

    const newTriangleCalculateB = getValueById('triangle-b');
    console.log(newTriangleCalculateB)

    const newTriangleCalculateH = getValueById('triangle-h');

    const newElement = newTriangleCalculateFraction * newTriangleCalculateB * newTriangleCalculateH;
    setAns('Triangle', newElement);
    if (newTriangleCalculateB < 0 ) {
        alert('get positive number')
    }
    else if (newTriangleCalculateH < 0) {
        alert('get positive number')
    }
})
